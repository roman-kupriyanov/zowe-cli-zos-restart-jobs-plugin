...
export const jesDefinition: ICommandDefinition = {
    ...
    description:
        "Restart a failed job by job ID and from step name is specified.",
    ...
    positionals: [
        {
            name: "jobid",
            description:
                "The job ID (e.g. JOB00123) of the job. Job ID is a unique identifier for z/OS batch jobs " +
        ...
        },
        {
            name: "stepname",
            description:
                "The step name (e.g. STEP1) of the job. Step name is a unique identifier for a step within " +
    ...
    examples: [
        {
            description:
                "Restart job with job ID JOB03456 starting from EXECSTEP3 step",
